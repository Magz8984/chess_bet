...
public class PawnPromotionDialog extends DialogFragment {
    ...
    public PawnPromotionDialog(Alliance alliance, PromotionPieceListener promotionPieceListener, Move promotionMove) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        PawnPromotionAdapter adapter = new PawnPromotionAdapter(alliance, requireContext(), promotionPieceListener, promotionMove);
